<template>
  ...
  <div id="carousel" class="svg-container">
    ...
    >
      ...
      <!-- prettier-ignore -->
      <text v-if="$route.name === 'index'" id="text-wrap" font-size="1em" stroke-width="1">
        <textPath
          id="text-path"
          xlink:href="#thePath"
          method="stretch"
      ...
      <text v-else-if="$route.name === 'people'" font-size="1em" stroke-width="1">
        <!-- prettier-ignore -->
        <textPath
          id="text-path"
          xlink:href="#thePath"
      ...
      <text
        v-else-if="
          $route.name === 'art' || $route.name === 'art-slug'
        "
        font-size="1em"
        stroke-width="1"
      >
